//
//  ayurvedaExaminationController.swift
//  NirogStreet
//
//  Created by Shivendra Pandey on 24/05/18.
//  Copyright © 2018 Diwakar Pandey. All rights reserved.
//

import UIKit

class ayurvedaExaminationController: UITableViewController {
 ...
 //   @IBOutlet var examinationLabel: UILabel!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ayurvedaExaminationCell", for: indexPath)
